        ...
        <div class="card-border">
            <div class="card-inner">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-2xl font-bold tracking-tight" style="color:#f1f5f9">Panel Admin & Guru</h1>
                    <p class="text-sm mt-1" style="color:rgba(148,163,184,.6)">Masuk ke akun administrator</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-5">
                    ...
                    <div>
                        <label for="username" class="field-label field-label-1">Username</label>
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <label for="remember_me" class="text-sm cursor-pointer select-none" style="color:rgba(148,163,184,.65)">
                            Ingat saya
                        </label>
                    </div>
